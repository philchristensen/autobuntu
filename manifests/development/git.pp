...
define autobuntu::development::git::checkout($dirname, $url, $path, $branch='master', $revision='', $manage_working_dir=true, $owner='root', $group='root', $mode='0755', $hard=false, $force=true, $shallow=false, $envvars=nil) {
  ###
  # required args
